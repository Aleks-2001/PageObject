...
public class QuestionAnswerAccordionTest extends BaseUITest {
    ...
    private final String answerMessage; // создали поля тестового класса

    public QuestionAnswerAccordionTest(String questionMessage, String answerMessage) {
        this.questionMessage = questionMessage;
        this.answerMessage = answerMessage;
    }

    @Parameterized.Parameters
    public static Object[] getAnswerString() {
        return new Object[][] {
                ...
                {"Я жизу за МКАДом, привезёте?", "Да, обязательно. Всем самокатов! И Москве, и Московской области."},   // передали тестовые данные
            };
        }
